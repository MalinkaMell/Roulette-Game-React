        ...
        <div className="d-flex flex-row">
          <div className="align-self-center">
            <ListGroup className="mx-1">
              <ListGroup.Item className="zeros" style={this.btnstyle} onClick={() => this.numsSelectionHandler("00")}>00
              </ListGroup.Item>
              <ListGroup.Item className="zeros" style={this.btnstyle} onClick={() => this.numsSelectionHandler("0")}>0</ListGroup.Item>
            </ListGroup>
          </div>
          <div className="align-self-center">
            {/* First row */}
            <ul className="mx-1 d-flex list-unstyled">
              {
          ...
          <div className="align-self-center">
            <ListGroup className="mx-1">
              <ListGroup.Item className="blues" style={{ cursor: "pointer" }} onClick={() => this.numsSelectionHandler("2:1 first")}>2:1</ListGroup.Item>
              <ListGroup.Item className="blues" style={{ cursor: "pointer" }} onClick={() => this.numsSelectionHandler("2:1 second")}>2:1</ListGroup.Item>
              <ListGroup.Item className="blues" style={{ cursor: "pointer" }} onClick={() => this.numsSelectionHandler("2:1 third")}>2:1</ListGroup.Item>
            </ListGroup>
          </div>
        </div >
